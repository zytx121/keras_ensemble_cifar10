...
if __name__ == '__main__':
    ...
    # set optimizer
    parallel_model = multi_gpu_model(senet, gpus=2)
    ...
    # start training
    start = time.time()
    parallel_model.fit_generator(datagen.flow(x_train, y_train,batch_size=batch_size), steps_per_epoch=iterations, epochs=epochs, callbacks=cbks,validation_data=(x_test, y_test))
