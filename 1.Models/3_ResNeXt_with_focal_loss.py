...
if __name__ == '__main__':
    ...
    parallel_model.compile(optimizer=optimizers.SGD(lr=.1, momentum=0.9, nesterov=True), loss=[focal_loss(classes_num)], metrics=['accuracy'])
